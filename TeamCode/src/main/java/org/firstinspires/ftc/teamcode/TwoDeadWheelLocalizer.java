...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2585.0795316988947; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1553.7147438830275; // x position of the perpendicular encoder (in tick units)
    }
